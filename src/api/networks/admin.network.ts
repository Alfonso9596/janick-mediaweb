...
const getAllRecipes = async () => {
  try {
    const response = await http.get(ADMIN_ENDPOINTS.allRecipes)
    return response?.data
  } catch (e) {
    console.error(e)
    return false
...
export { getPageableUsers, createUser, deleteUser, editUser, getAllRoles, getAllMovies, getAllSeries, getAllGames, getAllMusic, getAllRecipes }
