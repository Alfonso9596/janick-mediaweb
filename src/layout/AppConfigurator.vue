...
function updateColors(type, color) {
  if (type === 'primary') {
    ...
    configuratorStore.setConfiguratorSurface(color.name)
  }
...
function setupConfiguratorFromStorage() {
  ...
  layoutConfig.preset = configuratorStore.configuratorPreset
  layoutConfig.primary = configuratorStore.configuratorPrimary
